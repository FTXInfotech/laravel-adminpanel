<!--Action Button-->
    @if(Active::checkUriPattern('admin/cmspages'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.cmspages.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.cmspages.all')}}</a></li>
    @permission('create-cms-pages')
    <li><a href="{{route('admin.cmspages.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.cmspages.create')}}</a></li>
    @endauth
  </ul>
</div>
