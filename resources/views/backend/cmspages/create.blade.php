...
@section ('title', trans('labels.backend.cmspages.management') . ' | ' . trans('labels.backend.cmspages.create'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.cmspages.management') }}
        <small>{{ trans('labels.backend.cmspages.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.cmspages.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-permission']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.backend.cmspages.create') }}</h3>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::textarea('description', null,['class' => 'form-control box-size', 'placeholder' => trans('validation.attributes.backend.cmspages.description')]) }}
                    </div><!--col-lg-3-->
                </div><!--form control-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::textarea('seo_description', null,['class' => 'form-control box-size', 'placeholder' => trans('validation.attributes.backend.cmspages.seo_description')]) }}
                    </div><!--col-lg-3-->
                </div><!--form control-->
