...
@section ('title', trans('labels.backend.auth.permissions.management') . ' | ' . trans('labels.backend.auth.permissions.create'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.auth.permissions.management') }}
        <small>{{ trans('labels.backend.auth.permissions.create') }}</small>
    </h1>
@endsection
