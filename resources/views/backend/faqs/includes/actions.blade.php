    ...
    <div class="btn-group" role="group" aria-label="@lang('labels.backend.access.users.user_actions')">
        <a href="{{ route('admin.faqs.edit', $faq) }}" data-toggle="tooltip" data-placement="top" title="@lang('buttons.general.crud.edit')" class="btn btn-primary">
        ...
        <div class="btn-group btn-group-sm" role="group">
            ...
            <div class="dropdown-menu" aria-labelledby="companyActions">
                ...
                <a href="{{ route('admin.faqs.destroy', $faq) }}"
                   data-method="delete"
