            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    @if(!empty($blog->publish_datetime))
                        {{ Form::text('publish_datetime', \Carbon\Carbon::parse($blog->publish_datetime)->format('m/d/Y h:i a'), ['class' => 'form-control datetimepicker1 box-size', 'placeholder' => trans('validation.attributes.backend.access.blogs.publish_date_time'), 'required' => 'required', 'id' => 'datetimepicker1']) }}
                    @else
                        {{ Form::text('publish_datetime', null, ['class' => 'form-control datetimepicker1 box-size', 'placeholder' => trans('validation.attributes.backend.access.blogs.publish_date_time'), 'required' => 'required', 'id' => 'datetimepicker1']) }}
                    @endif
                </div><!--col-->
            </div><!--form-group-->
